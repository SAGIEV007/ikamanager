...
# onnxruntime is an optional (heavy) dependency. If it is not installed the
# local captcha solver is simply unavailable and the caller falls back to a
# remote service (or stops the automation).
...
def is_available() -> bool:
    """True if the local ONNX captcha solver can be used."""
